# Hyderra Product Requirements Document (PRD)

> **⚠️ Superseded by a product pivot — read this first.** This PRD describes the *original*
> ad-platform-only positioning. Hyderra has since pivoted: **tender/procurement discovery for
...
> exists in the codebase, but is now **admin-only internal tooling** the Hyderra team uses to run its
...
Hyderra is the digital growth and advertising platform connecting Sierra Leonean businesses, organizations, creators, and communities with local and global audiences (diaspora, NGOs, investors, and tourists).

### Positioning Statement
> Hyderra is the digital growth and advertising platform connecting Sierra Leonean businesses, organizations, creators, and communities with audiences in Sierra Leone and around the world.

### Current Positioning Statement (see `procurement-expansion-assessment.md` for full detail)
> Hyderra is a tender and procurement discovery platform for Sierra Leone and Liberia, helping
> suppliers find and win public and private sector opportunities, with an internal ad-platform module
> the Hyderra team uses to promote the product itself.
