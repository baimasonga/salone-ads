  ...
  return <div className="space-y-6 text-left">
    <section className="border border-slate-200 bg-slate-950 p-6 text-white">
      ...
      <div className="mt-1 flex flex-wrap items-end justify-between gap-4">
        <div><h2 className="font-display text-2xl font-extrabold !text-white">Pages &amp; Posts</h2><p className="mt-1 text-sm text-slate-300">Publish searchable, SEO-ready Hyderra stories and permanent pages.</p></div>
