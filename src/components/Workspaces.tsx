Warning: truncated output (original token count: 76694)
Total output lines: 5844
...
export function Workspaces({
  ...
  if (activeTab === 'admin-tender-review') {
    if (!isPlatformAdmin) {
      return (
        <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-xs text-sm text-slate-500">
          You do not …26694 tokens truncated…                  onChange={(e) => setEditHashtagsInput(e.target.value)}
